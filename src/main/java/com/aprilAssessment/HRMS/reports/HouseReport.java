...
public class HouseReport extends Database {

    public static void houseReport() {

        int houseCounter = 0, totalNumberOfBedrooms = 0;
        ...
        System.out.println("House details as follow:");
        System.out.printf("Total Number of all Apartments: %d%n", houseCounter);
